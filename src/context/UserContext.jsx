...
export const UserProvider = ({children}) =>{
    ...
    const createUser = async (dataForm) =>{
        try{
            const res = await clientAxios.post('https://mi-tienda-online.onrender.com/users/signup', dataForm)
    ...
    const verifyingToken = async () => {
        ...
        try {
          const res = token && (await clientAxios.get('https://mi-tienda-online.onrender.com/users/verify'))
          setUser(res.data)
          setAuthStatus(true)
        } catch (error) {
      ...
      const loginUser = async (dataForm) => {
        try {
          const res = await clientAxios.post('https://mi-tienda-online.onrender.com/users/login', dataForm)
          localStorage.setItem('token', res.data.token)
          setAuthStatus(true)
        } catch (error) {
          console.log(error)
